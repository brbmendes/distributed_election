            ...
            if(me.isCoordinator):
                while me.timer > 0:
                    ...
                    if(me.timer <= 0):
                        ...
                        print("t {} - (Coordinator Termination)".format(me.id))
                    time.sleep(1)
            time.sleep(1)
...
for i in lines:
    ...
    node = Node(int(splittedInfo[0]), splittedInfo[1],
                splittedInfo[2], False, 10, [], [])
